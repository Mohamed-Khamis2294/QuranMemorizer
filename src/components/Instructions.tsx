        ...
        >
          ...
          >
            ...
            <div className="flex items-start gap-2">
              ...
              <p>
                تلك الكلمة تظهر
                <span className="text-green-700 font-semibold"> باللون الأخضر </span>
              </p>
            </div>
            ...
            <div className="flex items-start gap-2">
              <Eye className="mt-1" />
              <p>
            يمكنك الضغط على الأزرار التي تظهر تحت آخر آية تم عرضها لعرض كلمة كلمة.او عرض الاية بالكامل او عرض اول كلمة وبعد الانتهاء من الحفظ يمكنك الانتقال إلى الآية التالية.
              </p>
            </div>
